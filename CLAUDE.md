...
A Spring Boot Starter for requesting and caching keycloak access token for outcome HTTP requests.
...
- For work with database follow the rules from https://raw.githubusercontent.com/panyukovnn/handbook/refs/heads/main/java/db-ai-rules.md
